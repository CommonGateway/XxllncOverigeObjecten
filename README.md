...
[![Automated Testing](https://github.com/CommonGateway/XxllncOverigeObjecten/actions/workflows/tests.yml/badge.svg)](https://github.com/CommonGateway/XxllncOverigeObjecten/actions/workflows/tests.yml)
...
- [API Documentation (redocly is a API documentation generator)](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/CommonGateway/XxllncOverigeObjecten/main/OAS.yaml&nocors)
- [API Definition (yaml or json file)](https://github.com/CommonGateway/XxllncOverigeObjecten/blob/main/OAS.yaml)
- [Public Code (file about this API and makes it searchable)](https://github.com/CommonGateway/XxllncOverigeObjecten/blob/main/publiccode.yaml)
...
- Execute the command `git clone (link you copied) (directory you want to clone the repository to`, an example: `git clone https://github.com/CommonGateway/XxllncOverigeObjectenAPI.git C:\Users\JohnDoe\Projects`.
...
```bash
git clone https://github.com/CommonGateway/XxllncOverigeObjectenAPI.git
cd PetStoreAPI
docker-compose up
```
...
`https://raw.githubusercontent.com/CommonGateway/XxllncOverigeObjectenAPI/main/publiccode.yaml`
